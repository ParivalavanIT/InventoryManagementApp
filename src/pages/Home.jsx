  ...
  
{
  ...
  return (
    ...
    <div className='bloc-tabs' >
      <h5 className={toggleState === 1 ? "tabs active-tabs":"tabs"} onClick={() => toggleTab(1)}>Recently purchased</h5>
      <h5 className={toggleState === 2 ? "tabs active-tabs":"tabs"} onClick={() => toggleTab(2)}>Recently Distributed</h5>
    </div>
    <hr />
